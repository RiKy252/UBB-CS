        ...
        IStmt ex12 = new CompStmt(new VarDeclStmt("v", new IntType()),
                ...
                new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(2))),
                        new CompStmt(new AssignStmt("w", new ValueExp(new IntValue(5))),
                                new CompStmt(new CallStmt("sum", new ArrayList<>(Arrays.asList(new ArithExp(new VarExp("v"),
                                                                                                                      new ValueExp(new IntValue(10)),
                                                                                                                      3), new VarExp("w")))),
                                        new CompStmt(new PrintStmt(new VarExp("v")), new ForkStmt(new CompStmt(
                                                new CallStmt("product", new ArrayList<>(Arrays.asList(new VarExp("v"), new VarExp("w")))),
                                                new ForkStmt(new CallStmt("sum", new ArrayList<>(Arrays.asList(new VarExp("v"), new VarExp("w")))))))))))));
                ...
                new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(0))),
                        new CompStmt(new WhileStmt(new RelationalExp(new VarExp("v"), new ValueExp(new IntValue(3)), "<"),
                                new CompStmt(new ForkStmt(new CompStmt(
                                        new PrintStmt(new VarExp("v")), new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), 1))
                                )), new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), 1)))),
                                new CompStmt(new SleepStmt(new IntValue(5)), new PrintStmt(new ArithExp(new VarExp("v"), new ValueExp(new IntValue(10)), 3))))));

        IStmt ex14 = new CompStmt(new VarDeclStmt("v", new IntType()),
                new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(10))),
                        new CompStmt(new ForkStmt(
                                new CompStmt(new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), 2)),
                                        new CompStmt(new AssignStmt("v", new ArithExp(new VarExp("v"), new ValueExp(new IntValue(1)), 2)),
                                                new PrintStmt(new VarExp("v"))))),
                                new CompStmt(new SleepStmt(new IntValue(10)), new PrintStmt(new ArithExp(new VarExp("v"), new ValueExp(new IntValue(10)), 3))))));
