...
public class ForkStmt implements IStmt {
    ...
    public PrgState execute(PrgState program) throws MyException {
        PrgState newProgram = new PrgState(new MyStack<>(), program.getSymTable().copy(), program.getOut(), program.getFileTable(), program.getHeap(), program.getSemaphoreTable(), inner);
