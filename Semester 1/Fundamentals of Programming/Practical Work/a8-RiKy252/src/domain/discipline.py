...
def generate_disciplines(number_of_disciplines: int):
    ...
    for index in range(number_of_disciplines):
        ...
        generated_disciplines.append(Discipline(discipline_id, discipline_name))

    return generated_disciplines


def test_generate_disciplines():
    first_discipline = Discipline(1, "Artificial Intelligence")
    second_discipline = Discipline(2, "Data Science")
    assert generate_disciplines(2) == [first_discipline, second_discipline]
