...
class TestMenuError(TestCase):
    def test_menu_error_message(self):
        menu_error = MenuError("Invalid menu option!")
        self.assertEqual(menu_error.message, "Invalid menu option!")

    def test_menu_error_string(self):
        menu_error = MenuError("Invalid menu option!")
        self.assertEqual(menu_error.__str__(), "Invalid menu option!")
